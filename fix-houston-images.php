<?php
// Fix the Houston page images with appropriate content
...
// Create enhanced content with APPROPRIATE images
$fixed_content = '
...
<div style="background: linear-gradient(135deg, #0d4c85 0%, #175ea6 100%); color: white; padding: 80px 20px; text-align: center; margin: -20px -20px 40px -20px; position: relative; overflow: hidden;">
    <div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; opacity: 0.3;">
        <img src="https://images.unsplash.com/photo-1591474200742-8e512e6f98f8?w=1920&h=600&fit=crop" alt="Houston Texas Skyline" style="width: 100%; height: 100%; object-fit: cover;">
    </div>
...
<div style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    ...
    <div style="display: flex; gap: 40px; align-items: center; margin-bottom: 60px; flex-wrap: wrap;">
        ...
        <div style="flex: 1; min-width: 300px;">
            <img src="https://images.unsplash.com/photo-1587923623987-1374b6962116?w=600&h=400&fit=crop" alt="Houston Texas Downtown Buildings" style="width: 100%; border-radius: 10px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
        </div>
    </div>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px; margin-bottom: 60px;">
        ...
        <div style="background: white; padding: 30px; border-radius: 15px; box-shadow: 0 5px 20px rgba(0,0,0,0.08); border-top: 4px solid #3ba55c;">
            <img src="https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=400&h=200&fit=crop" alt="Fast business approval" style="width: 100%; height: 200px; object-fit: cover; border-radius: 10px; margin-bottom: 20px;">
        ...
        <div style="background: white; padding: 30px; border-radius: 15px; box-shadow: 0 5px 20px rgba(0,0,0,0.08); border-top: 4px solid #3ba55c;">
            <img src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=200&fit=crop" alt="Keep driving your car" style="width: 100%; height: 200px; object-fit: cover; border-radius: 10px; margin-bottom: 20px;">
        ...
        <div style="background: white; padding: 30px; border-radius: 15px; box-shadow: 0 5px 20px rgba(0,0,0,0.08); border-top: 4px solid #3ba55c;">
            <img src="https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=400&h=200&fit=crop" alt="Financial approval" style="width: 100%; height: 200px; object-fit: cover; border-radius: 10px; margin-bottom: 20px;">
    ...
    <div style="margin-bottom: 60px;">
        ...
        <div style="display: flex; gap: 40px; align-items: center; flex-wrap: wrap; margin-bottom: 40px;">
            <div style="flex: 1; min-width: 300px;">
                <img src="https://images.unsplash.com/photo-1569163139394-de4798aa62b6?w=600&h=400&fit=crop" alt="Houston Highway System" style="width: 100%; border-radius: 10px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
            </div>
            <div style="flex: 1; min-width: 300px;">
    ...
    <div style="background: linear-gradient(135deg, #0d4c85 0%, #175ea6 100%); color: white; padding: 60px 40px; border-radius: 20px; margin-bottom: 60px;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 40px;">
            <div>
                <img src="https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?w=400&h=250&fit=crop" alt="Houston highway infrastructure" style="width: 100%; height: 250px; object-fit: cover; border-radius: 10px; margin-bottom: 20px;">
            ...
            <div>
                <img src="https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=400&h=250&fit=crop" alt="Oil refinery industry" style="width: 100%; height: 250px; object-fit: cover; border-radius: 10px; margin-bottom: 20px;">
            ...
            <div>
                <img src="https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=400&h=250&fit=crop" alt="Medical professional healthcare" style="width: 100%; height: 250px; object-fit: cover; border-radius: 10px; margin-bottom: 20px;">
    ...
    <div style="margin-bottom: 60px;">
        ...
        <div style="background: white; padding: 40px; border-radius: 15px; box-shadow: 0 5px 20px rgba(0,0,0,0.08);">
            <div style="display: flex; gap: 40px; align-items: center; flex-wrap: wrap;">
                <div style="flex: 1; min-width: 300px;">
                    <img src="https://images.unsplash.com/photo-1581650107963-3e8c1f48241b?w=600&h=400&fit=crop" alt="Pickup trucks and vehicles" style="width: 100%; border-radius: 10px;">
                </div>
                <div style="flex: 1; min-width: 300px;">
...
echo "Page fixed with appropriate images!\n";

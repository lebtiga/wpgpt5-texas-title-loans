<?php
/**
 * Template Name: Texas Hub - Main Landing Page
 * Description: Main Texas title loans landing page with full SEO optimization
 */
    ...
    <div class="container">
        <div class="hero__inner">
            <div class="hero__content">
                <h1 class="hero__title">Car Title Loans Across Texas</h1>
                ...
                <ul class="hero__bullets">
                    ...
                    <li>Serving all major Texas cities</li>
                </ul>
...
<section class="steps">
    <div class="container">
        <h2 class="section__title">Your 3-Step Path to Fast Funding in Texas</h2>
        <div class="cardgrid cardgrid--3">
            <article class="card">
                <h3 class="card__title">Step 1: Easy Application</h3>
                <p class="card__text">Tell us about you and your vehicle in a few minutes—online from anywhere in Texas.</p>
            </article>
            <article class="card">
                <h3 class="card__title">Step 2: Swift Approval</h3>
                <p class="card__text">We review your info quickly and share your Texas title loan options with clear terms.</p>
            </article>
            <article class="card">
                <h3 class="card__title">Step 3: Access Your Cash</h3>
                <p class="card__text">Get funds fast at Texas locations while you keep driving your car.</p>
            </article>
        </div>
    </div>
</section>
...
<section class="benefits">
    <div class="container">
        <h2 class="section__title">Texas Title Loan Services</h2>
        <div class="cardgrid cardgrid--3">
            <article class="card">
            ...
            <article class="card">
                ...
                <p class="card__text">Apply 100% online from anywhere in Texas. Upload documents and get approved without visiting a store.</p>
            </article>
            <article class="card">
        ...
        <div class="cardgrid cardgrid--3" style="margin-top: 16px;">
            <article class="card">
                ...
                <p class="card__text">Need cash for emergencies? Same-day funding available for qualified Texas applicants.</p>
            </article>
            <article class="card">
                ...
                <p class="card__text">Beyond cars - use trucks, SUVs, motorcycles, or RVs as collateral for your Texas title loan.</p>
            </article>
            <article class="card">
                <h3 class="card__title">Fast Approval Process</h3>
                <p class="card__text">Most Texas applications approved within hours. Get your cash the same day you apply.</p>
            </article>
        </div>
    </div>
</section>
...
<section class="eligibility">
    <div class="container eligibility__inner">
        <div class="eligibility__content">
            <h2 class="section__title">Texas Title Loan Requirements</h2>
            <ul class="checklist">
                <li><strong>Vehicle Title:</strong> Clear title in your name (no liens)</li>
                <li><strong>Texas ID:</strong> Valid driver's license or state ID</li>
            ...
            <p class="muted">These basics help confirm your eligibility and speed up approval across all Texas locations.</p>
            <div style="margin-top: 20px;">
                <a href="#apply" class="button button--primary">Apply Now</a>
            </div>
        </div>
        <div class="eligibility__image">
            <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=640&h=420&fit=crop" alt="Texas car title loan approval process" />
        </div>
    </div>
</section>
...
<section class="usecases">
    <div class="container">
        <h2 class="section__title">Common Uses for Texas Title Loans</h2>
        <div class="cardgrid cardgrid--3">
            <article class="card">
            ...
            <article class="card">
                <h3 class="card__title">Hurricane Recovery</h3>
                <p class="card__text">Texas storms cause damage. Get funds for repairs not covered by insurance.</p>
            </article>
            <article class="card">
...
<section class="eligibility">
    <div class="container">
        <article class="content-article">
            ...
            <h2 class="section__title">Texas Car Title Loans - Fast Cash When You Need It</h2>
            <p>Welcome to Texas's premier car title loan service, where we help residents across the Lone Star State access quick cash using their vehicle's equity. Whether you're in Houston, Dallas, San Antonio, Austin, or any other Texas city, our streamlined online application process makes it easy to get the funds you need without the hassle of traditional bank loans.</p>
            
            <h3 style="margin-top: 30px; margin-bottom: 15px;">Why Choose Car Title Loans in Texas?</h3>
